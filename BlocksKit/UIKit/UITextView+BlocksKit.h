 ...
 */
@property (nonatomic, copy, nullable) BOOL(^bk_shouldBeginEditingBlock)(__kindof UITextView *textView);

/**
 *	The block that fires after the receiver begins editing
 */
@property (nonatomic, copy, nullable) void(^bk_didBeginEditingBlock)(__kindof UITextView *textView);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^bk_shouldEndEditingBlock)(__kindof UITextView *textView);

/**
 *	The block that fires after the receiver ends editing
 */
@property (nonatomic, copy, nullable) void(^bk_didEndEditingBlock)(__kindof UITextView *textView);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^bk_shouldChangeCharactersInRangeWithReplacementTextBlock)(__kindof UITextView *textView, NSRange range, NSString *text);

/**
 *	The block that fires after the receiver's text changed
 */
@property (nonatomic, copy, nullable) void(^bk_didChangeBlock)(__kindof UITextView *textView);

/**
 *	The block that fires after the receiver changes selection
 */
@property (nonatomic, copy, nullable) void(^bk_didChangeSelecionBlock)(__kindof UITextView *textView);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^bk_shouldInteractWithTextAttachmentInRangeBlock)(__kindof UITextView *textView, NSTextAttachment *attachment, NSRange range);
 ...
 */
@property (nonatomic, copy, nullable) BOOL(^bk_shouldInteractWithURLInRangeBlock)(__kindof UITextView *textView, NSURL *url, NSRange range);
